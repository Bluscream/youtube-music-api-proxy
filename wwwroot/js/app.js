...
function toggleSidebar() {
    ...
    if (shouldCollapseSidebar()) {
        ...
        if (isSidebarCollapsed) {
            ...
            sidebarToggle.style.left = '20px'; // Ensure button is visible when sidebar is collapsed
        } else {
            // Open sidebar
            sidebar.classList.remove('collapsed');
            ...
            sidebarToggle.style.left = '260px'; // Position button next to open sidebar
        }
...
function restoreSidebarState() {
    ...
    try {
        ...
        if (savedState) {
            ...
            // No saved state on desktop - ensure sidebar is visible by default
            sidebar.classList.remove('collapsed');
            mainContent.classList.remove('sidebar-collapsed');
            sidebarToggle.textContent = '◀';
            sidebarToggle.title = 'Collapse sidebar';
        ...
        // On error, default to visible sidebar
        sidebar.classList.remove('collapsed');
        mainContent.classList.remove('sidebar-collapsed');
        sidebarToggle.textContent = '◀';
        sidebarToggle.title = 'Collapse sidebar';
...
function handleWindowResize() {
    ...
    if (shouldCollapseSidebar()) {
        ...
        // Ensure sidebar is visible by default on desktop if no state is set
        if (!sidebar.classList.contains('collapsed') &&
            !mainContent.classList.contains('sidebar-collapsed')) {
            // Default to visible sidebar on desktop if no state is set
            sidebar.classList.remove('collapsed');
            mainContent.classList.remove('sidebar-collapsed');
            sidebarToggle.style.left = '260px';
            isSidebarCollapsed = false;
